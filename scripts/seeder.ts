...
const disciplines = [
  ...
  },
  {
    ...
    powers: [
      {name: PowerName.CATS_GRACE, cost: PowerCost.FREE, level: 1, duration: Duration.PASSIVE},
      {name: PowerName.RAPID_REFLEXES, cost: PowerCost.FREE, level: 1, duration: Duration.PASSIVE},
      {name: PowerName.FLEETNESS, cost: PowerCost.ROUSE_CHECK, level: 2, duration: Duration.SCENE},
      {
  ...
  },
  {
    ...
    powers: [
      {name: PowerName.RESILIENCE, cost: PowerCost.FREE, level: 1, duration: Duration.PASSIVE},
      {name: PowerName.UNSWAYABLE_MIND, cost: PowerCost.FREE, level: 1, duration: Duration.PASSIVE},
      {name: PowerName.COMPELL, cost: PowerCost.ROUSE_CHECK, level: 2, duration: Duration.SCENE},
    ],
  },
  {
  ...
  },
  {
    ...
    powers: [
      {name: PowerName.LETHAL_BODY, cost: PowerCost.FREE, level: 1, duration: Duration.PASSIVE},
      {name: PowerName.SOARING_LEAP, cost: PowerCost.FREE, level: 1, duration: Duration.PASSIVE},
      {name: PowerName.PROWESS, cost: PowerCost.ROUSE_CHECK, level: 1, duration: Duration.SCENE},
    ],
  },
  {
    ...
    powers: [
      ...
      {name: PowerName.DAUNT, cost: PowerCost.FREE, level: 1, duration: Duration.SCENE},
      {name: PowerName.LINGERING_KISS, cost: PowerCost.FREE, level: 1, duration: Duration.RESISTED},
    ],
  },
  {
